...
data_dir = r"D:\CLS PROJECT\CXR8"
 # Data_Entry_2017.csv should be present in the mentioned path
...
if not args.test: # training
    ...
    if not args.resume:
        ...
        ckpt = torch.load(os.path.join(config.models_dir, args.ckpt), weights_only=False)
...
h, m = divmod(m, 60)
print("It took {} hours {} minutes for the whole script!".format(int(h), int(m)))
